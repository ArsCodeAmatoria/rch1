  ...
  return (
    <div className={riggingEducationArticleClass}>
      <section id="introduction" className="not-prose space-y-5 text-base leading-relaxed text-foreground">
        ...
        <p>
          Understanding rigging equipment is essential because every component within a lifting system contributes to overall load stability
          and operational safety. Improper selection, misuse, incompatible components, or damaged equipment can result in equipment failure,
          load instability, or catastrophic lifting incidents.
        </p>
        <p>
      ...
      <p>
        Hoist rings are engineered lifting attachment points designed to rotate and align with load direction.
      </p>
      <p>
      ...
      <p>
        Lifting beams support loads directly beneath the beam structure and are commonly used where headroom is limited, precise load support
        is required, or sling angle reduction is necessary.
      </p>
