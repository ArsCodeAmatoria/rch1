...
export async function generateMetadata({params}: {params: Promise<{locale: string}>}): Promise<Metadata> {
  ...
  return mergePlaceholderForTrainingSection("tower-crane-controls-monitoring", buildPageMetadata({
    locale,
...
export default async function TowerCraneControlsMonitoringPage() {
  ...
  return (
    <article className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8 2xl:max-w-7xl">
      ...
      <OperatorTrainingLeadPlaceholder section="tower-crane-controls-monitoring" />
