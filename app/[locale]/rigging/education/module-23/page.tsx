...
export async function generateMetadata({params}: {params: Promise<{locale: string}>}): Promise<Metadata> {
  ...
  return mergePlaceholderImageMeta(
    ...
    buildPageMetadata({
      ...
      title: isFr ? "Module 23 — Ingénierie des levages lourds et montage avancé" : titleEn,
      description: isFr
        ? "Module pédagogique : plans de levage, portance des sols, palans à torons, portiques hydrauliques, translation, SPMT, instrumentation. (Texte principal en anglais.)"
        : descriptionEn,
      keywords: [
