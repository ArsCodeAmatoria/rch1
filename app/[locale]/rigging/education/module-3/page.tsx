...
const titleEn = "Module 3 — Inspection & Removal Criteria | Rigging Education";
const descriptionEn =
  "Educational module: rigging inspection types, documentation, wire rope 3–6 rule and standing/rotation-resistant criteria, wire rope sling removal, chain and synthetic sling defects, hook and shackle inspection, removal from service, storage, and inspection culture.";
...
export default async function RiggingEducationModule3Page() {
  ...
  const pageUrl = `${SITE_URL}/${locale}/rigging/education/module-3`;
  ...
  const breadcrumb = [
    ...
    {name: "Module 3 — Inspection & removal", url: pageUrl}
  ];
    ...
    <article className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <JsonLd
        data={buildTechArticleSchema({
          ...
          url: pageUrl,
          locale,
          keywords: ["ASME B30.30", "B30.9", "inspection", "wire rope", "removal from service", "rigging"],
          about: ["Rigging inspection", "Crane ropes", "Slings"]
        })}
      />
      ...
      <header className="space-y-3 rounded-xl border border-border bg-card p-6">
        <Badge className="w-fit">Rigging education · Module 3</Badge>
        ...
        <p className="not-prose pt-1">
          <Link href={"/rigging/education/slides/module-3" as never} className="text-sm font-medium text-primary hover:underline">
