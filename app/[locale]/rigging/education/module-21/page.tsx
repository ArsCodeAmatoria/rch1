...
const titleEn = "Module 21 — Knots, Hitches & Rope Applications | Rigging Education";
const descriptionEn =
  "Educational module: rope types (natural, synthetic, kernmantle, braided, twisted), stretch and dynamic vs static rope, inspection and storage, knot efficiency, snap-back and tensioning, bowline, figure eight, hitches, taglines, abrasion and chemical exposure, human factors, and situational awareness for rope use in rigging.";
...
export default async function RiggingEducationModule21Page() {
  ...
  const pageUrl = `${SITE_URL}/${locale}/rigging/education/module-21`;
  ...
  const breadcrumb = [
    ...
    {name: "Module 21 — Knots & rope", url: pageUrl}
  ];
    ...
    <article className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <JsonLd
        data={buildTechArticleSchema({
          ...
          url: pageUrl,
          locale,
          keywords: ["clove hitch rigging", "figure eight knot rope", "tagline crane load", "rope recoil zone"],
          about: ["Rigging", "Rope", "Knots", "Load control"]
        })}
      />
      ...
      <nav aria-label="Breadcrumb" className="mb-6 text-sm text-muted-foreground">
        ...
        / <span className="text-foreground">Module 21</span>
      </nav>

      <header className="space-y-3 rounded-xl border border-border bg-card p-6">
        <Badge className="w-fit">Rigging education · Module 21</Badge>
        ...
        <p className="not-prose pt-1">
          <Link href={"/rigging/education/slides/module-21" as never} className="text-sm font-medium text-primary hover:underline">
